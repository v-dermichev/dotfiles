...
-- Scratchpads
hl.workspace_rule({ workspace = "special:music", on_created_empty =
"chromium --app=https://music.yandex.ru --profile-directory=Music" })
hl.workspace_rule({ workspace = "special:messenger", on_created_empty =
"chromium --app=https://messenger.360.yandex.com/ --profile-directory=Messenger" })
...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd(
  "gnome-keyring-daemon --start --components=secrets --control-directory=/run/user/1000/keyring")
...
hl.bind(mod .. " + T", hl.dsp.exec_cmd("~/.config/hypr/scripts/toggle-app-transparency.sh"))

-- hl.bind(mod .. " + C", hl.dsp.exec_cmd("~/.config/hypr/scripts/wofi-wrapper.sh cliphist"))

hl.bind(mod .. " + Return", hl.dsp.exec_cmd("kitty"))
hl.bind(mod .. " + D", hl.dsp.exec_cmd("~/.config/hypr/scripts/launcher.sh"))
hl.bind(mod .. " + Q", hl.dsp.exec_cmd("~/.config/hypr/scripts/close-focused.sh"))
...
hl.bind(mod .. " + W",
  hl.dsp.exec_cmd("~/.config/hypr/scripts/workspace-launch.sh Windows virt-manager"))
...
hl.bind(mod .. " + SHIFT + S",
  ...
  screenshotDir .. [[ -f "$(date +'%Y-%m-%d-%H%M%S').png" --raw | tee >(wl-copy) | swappy -f -]]))
hl.bind(mod .. " + SHIFT + D",
  hl.dsp.exec_cmd("hyprshot -m region -o " ..
  screenshotDir .. [[ -f "$(date +'%Y-%m-%d-%H%M%S').png"]]))
hl.bind(mod .. " + SHIFT + W",
  hl.dsp.exec_cmd("hyprshot -m window -o " ..
  screenshotDir .. [[ -f "$(date +'%Y-%m-%d-%H%M%S').png"]]))
hl.bind(mod .. " + SHIFT + M",
  hl.dsp.exec_cmd("hyprshot -m output -o " ..
  screenshotDir .. [[ -f "$(date +'%Y-%m-%d-%H%M%S').png"]]))
hl.bind("Print",
  hl.dsp.exec_cmd("hyprshot -m output -o " ..
  screenshotDir .. [[ -f "$(date +'%Y-%m-%d-%H%M%S').png"]]))
